...
<div class="mx-auto mb-12 max-w-5xl">
	<h2 class="font-display text-gradient mb-2 text-4xl font-extrabold tracking-tight md:text-5xl">
		Upload Assets
	</h2>
	<p class="font-body text-sm tracking-widest uppercase text-on-surface-variant">
